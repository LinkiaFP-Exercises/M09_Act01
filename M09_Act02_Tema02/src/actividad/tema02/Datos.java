...
/**
 * La clase Datos modela un conjunto de datos que incluye el total, el estado de
 * si hay suficiente para restar, y si el hilo estaba en estado de espera.
 * Permite realizar operaciones de suma y resta con control de hilo para
...
public class Datos {
	...
	/**
	 * Constructor de la clase Datos que inicializa el valor total.
	 *
